# META KNOWLEDGE BASE - Patch 7.37+
# Fuente: Dota2ProTracker, Liquipedia, DotaBuff
...
CRITICAL_COUNTERS = {
    "illusion_heroes": {
        ...
        "counters": "Mjollnir, Shiva's, Ember Spirit, Leshrac, Medusa. Sin AoE = auto-lose."
    },
    "regen_tanks": {
    ...
    "invis_heroes": {
        ...
        "counters": "Sentries en lane, Dust en supports, Gem a 25min. Sin detection = 4v5."
    },
    "magic_burst": {
